...
tools/dist_test.sh configs/faster_rcnn_r50_fpn_1x.py work_dirs/faster_rcnn_r50_fpn_1x/epoch_90.pth 4 --out work_dirs/faster_rcnn_r50_fpn_1x/test_out.pkl --eval bbox --show #--eval proposal proposal_fast bbox --show
