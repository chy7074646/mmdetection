...
model = dict(
    ...
    neck=dict(
        type='FPN',
        in_channels=[96,256],#[256,512,1024,2048],#[96,256],#[96,192,256,256,256], #[256,512,1024,2048]
        out_channels=256,
        num_outs=5),#5
...
load_from = None #'./work_dirs/faster_rcnn_r50_fpn_1x/epoch_92.pth'#None                                  # 加载模型的路径，None表示从预训练模型加载
